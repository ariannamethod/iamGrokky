...
async def query_gpt4(
    ...
    The default model is set to ``gpt-4o`` to leverage the latest
...
class DynamicWeights:
    ...
    def pulse_from_prompt(
        ...
        # knowledge can already yield noticeable pulse values, enabling
        # lightweight models to vary their responses.
    ...
    def generate_response(
        ...
        replies. This enables the system to "speak" without relying on static
        templates.
        """
